const experience = [
    ...
    // },
    {
        ...
        list: [
            ...
            'Taught engineers and aspiring programmers of all skill levels how to design, build, host, and support modern web applications.',
    ...
    },
    {
        ...
        list: [
            ...
            'Migrated the Lotus Notes environment to SharePoint 2016.',
        ],
    },
    {
        ...
        list: [
            'Led a team of five developers at the Executive Office of the President where we modernized their SharePoint user experience and worked with the National Archives and Records Administration (NARA) to build tools that export records before the next administration took office.',
