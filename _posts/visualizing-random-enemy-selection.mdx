...
date: 'August 2, 2023'
lastModified: 'August 6, 2023'
author: Stephen Matheis
tags:
  - PICO-8
---

In [Lazy Game Dev's](https://www.youtube.com/@LazyDevs) [Shmup Tutorial](https://youtube.com/playlist?list=PLea8cjCua_P3Sfq4XJqNVbd1vsWnh7LZd) episode [#24 - Enemy Movement](https://youtu.be/0UoE_rUl1qc) we're encouraged to create a method for selecting the next enemy to launch an attack from a 4 x 10 grid of enemies.

There's only one criteria: **_enemies should be chosen from the bottom most row in a given column_**.

I had a hard time visualizing how this would work. There are a more things to think about than I had first realized.

- What should happen if the selected enemy is alredy attacking?
- ???

So I created this tool to experiment with different ways to select the next enemy.
...
The best I could come up with is to randomly select
...
And here is in it's orginal format.
